...
function profileHTML(sfx) {
  ...
  return '<div class="phero">'
    ...
    + '<div class="lang-opt' + (LANG === 'en' ? ' sel' : '') + '" data-lang="en" data-set-lang="en"><span>🇬🇧</span> English</div>'
    + '<div class="lang-opt' + (LANG === 'ru' ? ' sel' : '') + '" data-lang="ru" data-set-lang="ru"><span>🇷🇺</span> Русский</div>'
    + '</div></div>'
